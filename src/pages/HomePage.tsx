    ...
    <>
      ...
      <section className="py-24 px-6 lg:px-12 bg-white border-t border-[#eaeae1]">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 mb-10 pb-4 border-b border-[#eaeae1]/60">
            {[
              { id: "all", label: "Tất cả" },
              ...
              <button
                ...
                className={`px-2 py-1.5 text-xs tracking-wider uppercase transition-luxury whitespace-nowrap ${
                  faqCategory === cat.id
